...
import { clearProduct } from '../../redux/slices/cart/slice';
...
const Cart: React.FC = () => {
  ...
  const onClickBuy = () => {
    window.alert('Товар придбано, дякую');
    dispatch(clearProduct());
  };
      ...
      <div className="cart">
        ...
        <div className="cart__bottom">
          ...
          <div className="cart__bottom-buttons">
            ...
            <div onClick={onClickBuy} className="button pay-btn">
